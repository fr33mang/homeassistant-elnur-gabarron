...
class ElnurGabarronEcoTempSensor(ElnurGabarronSensorBase):
    """Economy temperature setting sensor."""

    def __init__(self, coordinator, full_device_id, device_id, zone_id, zone_name):
        """Initialize the eco temp sensor."""
        super().__init__(coordinator, full_device_id, device_id, zone_id, zone_name)
        self._attr_unique_id = f"{DOMAIN}_{device_id}_{zone_id}_eco_temp"
        self._attr_native_unit_of_measurement = UnitOfTemperature.CELSIUS
        self._attr_device_class = SensorDeviceClass.TEMPERATURE
        self._attr_icon = "mdi:leaf"
        self._attr_entity_registry_enabled_default = False  # Disabled by default (use number entities instead)
...
class ElnurGabarronComfortTempSensor(ElnurGabarronSensorBase):
    """Comfort temperature setting sensor."""

    def __init__(self, coordinator, full_device_id, device_id, zone_id, zone_name):
        """Initialize the comfort temp sensor."""
        super().__init__(coordinator, full_device_id, device_id, zone_id, zone_name)
        self._attr_unique_id = f"{DOMAIN}_{device_id}_{zone_id}_comfort_temp"
        self._attr_native_unit_of_measurement = UnitOfTemperature.CELSIUS
        self._attr_device_class = SensorDeviceClass.TEMPERATURE
...
class ElnurGabarronAntiFrostTempSensor(ElnurGabarronSensorBase):
    """Anti-frost temperature setting sensor."""

    def __init__(self, coordinator, full_device_id, device_id, zone_id, zone_name):
        """Initialize the anti-frost temp sensor."""
        super().__init__(coordinator, full_device_id, device_id, zone_id, zone_name)
        self._attr_unique_id = f"{DOMAIN}_{device_id}_{zone_id}_antifrost_temp"
        self._attr_native_unit_of_measurement = UnitOfTemperature.CELSIUS
        self._attr_device_class = SensorDeviceClass.TEMPERATURE
